...
# docker run -v $(pwd)/turtlemarinecoind:/var/lib/turtlemarinecoind -v $(pwd)/wallet:/home/turtlemarinecoin --rm -ti turtlemarinecoin:0.2.2
...
ARG TURTLEMARINECOIN_VERSION=v420
ENV TURTLEMARINECOIN_VERSION=${TURTLEMARINECOIN_VERSION}
